...
import com.sssl.seqrgraphdemo.databinding.FragmentVerifierScanBinding;
...
public class VerifierScanFragment extends Fragment {

    AppSharedPreference appSharedPreference;

    FragmentVerifierScanBinding binding;

    NavController navController;

    public VerifierScanFragment() {
        // Required empty public constructor
    }

    public static VerifierScanFragment newInstance(String param1, String param2) {
        VerifierScanFragment fragment = new VerifierScanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVerifierScanBinding.inflate(inflater, container, false);
    ...
    private void updateToolbarText() {
        ...
        if (activity != null) {
            ...
            toolbarTextView.setText("Scan OR");
        }
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        navController = NavHostFragment.findNavController(VerifierScanFragment.this);
...
//        options.setCameraId(0);  // Use a specific camera of the device
    ...
    private void getScanAPI(String key){
        ...
        Log.d("Tag" , key);
        Log.d("Tag" , appSharedPreference.getUserName());
        Log.d("Tag" , "hf" + appSharedPreference.getUserId());

        Map<String, String> headers = AppUtils.getApiHeader(requireContext());

        Log.d("Tag" , "header response "+headers);

        ApiSeQRClient.getInstance().seqrCodeService.verifierScanViewCertificate(headers , verifierViewCertificateRequest).enqueue(new Callback<ViewCertificateResponse>() {
            @Override
                ...
                if (response.isSuccessful()) {
                    ...
                    if(apiResponse.success){
                        if (apiResponse != null && apiResponse.getData() != null) {
                            ...
                            args.putString("serialNo", responseData.serial_no);
                            args.putString("key", responseData.key);
                            args.putString("scanResult", responseData.scan_result);

                            binding.loadingProgress.setVisibility(View.GONE);
                            navController.navigate(R.id.action_verifierScanFragment_to_viewCertificateFragment , args);
